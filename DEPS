...
vars = {
  ...
  'dxc_revision': 'c524046e26fc5fec0b2ef5aa0f3c3b71fdf7bdce',
  ...
  'spirv_tools_revision': '5508dee6d7b949333340456662fa34eefa4cd39a',
...
deps = {
  ...
  'third_party/dxc': Var('jaebaek_git') + '/DirectXShaderCompiler.git@' +
      Var('dxc_revision'),
